...
<body>
    ...
    $query = "SELECT id, id_pic, fname, lname, id_no, email, position, status FROM users WHERE status = 'blocked'";
    ...
    <?php
        ...
        echo '<div class="no-users-message">No blocked users found.</div>';
    }
    ?>
